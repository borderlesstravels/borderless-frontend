...
function MyBookingsPage() {
  ...
  const [selectedTab, setSelectedTab] = useState<"flights" | "stays" | "rides">(
    mode === "stays" ? "stays" : "flights"
  );
      ...
      <div className="booking-banner">
        ...
        <div className="user-info-card">
          ...
          <div className="spread-info-web">
            <h3 className="h3b">
              Tickets/<span className="purple-tx">Bookings</span>
            </h3>
            <div className="spread-info py-2">
              <div className="m-drop-down-case">
                <p className="mb-0 reduced-x px-1">
                  ...
                  <FontAwesomeIcon
                    icon={"chevron-down"}
                    className="mx-1 orange-tx reduced-soft"
                  />
                </p>
          ...
          <div className="category-tabs">
            <div
              className={
                "category-tab" + (selectedTab === "flights" ? " active" : "")
              }
              onClick={() => updateSelectedTab("flights")}
            >
              <div className="spread-info-front py-2">
                ...
                <FontAwesomeIcon
                  icon={"plane"}
                  className={
                    "mx-3" + (selectedTab === "flights" ? " orange-tx" : "")
                  }
                />
              </div>
            </div>
            ...
            <div
              className={
                "category-tab" + (selectedTab === "stays" ? " active" : "")
              }
              onClick={() => updateSelectedTab("stays")}
            >
              <div className="spread-info-front py-2">
                ...
                <FontAwesomeIcon
                  icon={"bed"}
                  className={
                    "mx-3" + (selectedTab === "stays" ? " orange-tx" : "")
                  }
                />
              </div>
            </div>
            ...
            <div
              className={
                "category-tab" + (selectedTab === "rides" ? " active" : "")
              }
              onClick={() => updateSelectedTab("rides")}
            >
              <div className="spread-info-front py-2">
                ...
                <FontAwesomeIcon
                  icon={"car"}
                  className={
                    "mx-3" + (selectedTab === "rides" ? " orange-tx" : "")
                  }
                />
              </div>
            </div>
