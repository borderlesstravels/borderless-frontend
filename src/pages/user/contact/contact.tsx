...
import { useContactUsMutation } from "../../../store/apis/contact";

function Contact() {
  const [contactUsMutate] = useContactUsMutation();
  ...
  const sendForm = async (values: any, controls: FormikHelpers<any>) => {
    try {
      const res = await contactUsMutate(values).unwrap();
      ...
      toast.error(error.responseText || "Request failed");
    }
  };
  ...
  return (
    <div className="contact">
      <HeroSect />
      <div className="py-5">
        <h3 className="h3b text-center pt-4">
          Get in <span className="purple-tx"> Touch</span>
        </h3>
            ...
            <div className="c-info-grid">
              ...
              <div className="contact-text">
                <p className="reduced-soft">
                  901 N Pitt Str., Suite 170 <br /> Alexandria, VA 22314, USA
                </p>
              </div>
            </div>
            <div className="pt-4">
          ...
          <div className="form-side">
            <div className="admin-apply-box">
              <Formik
                ...
                onSubmit={(values, controls) => sendForm(values, controls)}
              >
                {(
                  props: FormikProps<{
                    name: string;
