...
import {
  iStrictAddress,
  IStrictStaySearchData,
  storedCombinedStayData as sData,
...
function StaysPage(props: any) {
  ...
  const searchStays = (stayData = sData) => {
    ...
    setStayList([]);
    const param = {
      startDate: stayData?.date?.startDate?.toISOString()?.split("T")[0] || "",
      endDate: stayData?.date?.endDate?.toISOString()?.split("T")[0] || "",
      lga: stayData?.location?.address?.lga?.replace(/ /g, "-") || "",
      state: stayData?.location?.address?.state?.replace(/ /g, "-") || "",
      country: stayData?.location?.address?.country?.replace(/ /g, "-") || "",
    };
    setSearchParam(param);

    sendRequest(
      {
        url: "shortlet/fetch-shortlets" + stringifyFilter(param),
        method: "GET",
      },
      (res: any) => {
        ...
        {staysSearched ? (
            ...
            <StaySearchFilter list={stayList} updateList={updateFilter}>
              {!loading && (
                <p className="reduced-x">
                  <span className="blue-tx number-bold">
                    Showing {filteredStayList.length} of
                  </span>
                  <span className="orange-tx number-bold">
                    {" "}
                    {filteredStayList.length} stays
                  </span>
                </p>
              )}
                    ...
                    <div className="content-side spread-info-vertical">
                      <div className="w100-flat">
                        <div className="spread-info mb-2">
                          ...
                          <div className="">
                            <p className="mb-0 reduced-x faint-tx">
                              Starting from
                            </p>
                            <h5 className="orange-tx number-bold">
                              {calculatePrice(stay)}
                              <span className="reduced-xl-im">/day</span>
                            </h5>
                          </div>
                        </div>
                        ...
                        <div className="spread-info mb-2">
                          <div className="spread-info">
                            ...
                            <h6 className="mb-0 mx-3">
                              ...
                              &nbsp; <span className="number-medium"> 231</span>{" "}
                              Reviews
                            </h6>
                          </div>
                        </div>
                      ...
                      <div className="description-grid-50 w100-flat">
                        ...
                        <div className="pl-3">
                          <button
                            ...
                            onClick={() => viewStayDetails(stay._id)}
                          >
                            View Shortlet
                          </button>
                        </div>
          ...
          <div className="stay-info">
            <div className="w90 max1100">
              <h3 className="h3b pb-4">
                Your recent <span className="orange-tx"> searches</span>
              </h3>
              <div className="row">
                <div className="col-lg-3 col-sm-6 py-2">
                  <div className="description-grid-80" data-aos="zoom-out">
                    <div className="imh">
                      <img
                        src={PropertyRecentSearch1}
                        className="rad-10 shadowed"
                        alt=""
                      />
                    </div>
                ...
                <div className="col-lg-3 col-sm-6 py-2">
                  <div
                    className="description-grid-80"
                    data-aos="zoom-out"
                    data-aos-delay="200"
                  >
                    <div className="imh">
                      <img
                        src={PropertyRecentSearch2}
                        className="rad-10 shadowed"
                        alt=""
                      />
                    </div>
            ...
            <StayLocationDealsSect>
              <div className="w90 max1100 pt-5">
                <h3 className="h3b">
                  Favorite Hotels{" "}
                  <span className="orange-tx"> Round the Globe</span>
                </h3>
