...
function LatestSect() {
  const testimonyCarousel = testimonyList.map((data, index) => {
    return (
      <div className="testimony-slide-case" key={index}>
  ...
  const newsCarousel = newsList.map((data, index) => {
    return (
      <div className="news-case" key={index}>
        <div
          className="news-card"
          data-aos="zoom-in"
  ...
  return (
    <>
      <div className="testimony-sect">
        <h3 className="h3b text-center">
          <span className="purple-tx">What our happy </span> client say
        </h3>
      ...
      <div className="latest">
        <div>
          <h3 className="text-center h3b">
            Keep Abreast on the{" "}
            <span className="orange-tx"> Latest Travel Info</span>
          </h3>
