...
} from "../../../user/stays/stay-search/stay-search-service";
                    ...
                    <div className="mb-2 reduced-soft">
                      ...
                      <div className="spread-info-front">
                        <p className="mb-0 number-light">
                          ...
                          {selectAppartmentCategory(property).count} Unit
                          {selectAppartmentCategory(property).count !== 1 &&
                            "s"}
                          )
                        </p>
                        <p className="mb-0">
                    ...
                    <div className="spread-info mb-2">
                      <div className="spread-info">
                        ...
                        <h6 className="mb-0 mx-3">
                          <span className="font-weight-bold">Very Good</span>{" "}
