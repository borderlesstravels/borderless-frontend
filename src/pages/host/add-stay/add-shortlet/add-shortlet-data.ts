...
export const preparePropertyData = (basicInfo: iBasicInfo, advancedInfo: iAdvancedInfo) => {
    ...
    formData.append('single_price', (advancedInfo.single_price || '').toString())
    formData.append('suites', advancedInfo.suites.toString())
    formData.append('suites_price', (advancedInfo.suites_price || '').toString())
    formData.append('executive', advancedInfo.executive.toString())
    formData.append('executive_price', (advancedInfo.executive_price || '').toString())
    formData.append('double_chambers', advancedInfo.double_chambers.toString())
    formData.append('double_chambers_price', (advancedInfo.double_chambers_price || '').toString())
