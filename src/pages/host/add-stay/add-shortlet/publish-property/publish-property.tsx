...
import { handleLogout } from "../../../../../store/features/user";

function PublishPropertySect({
  basicData,
  advancedData,
  revert,
}: {
  basicData: iBasicInfo;
  advancedData: iAdvancedInfo;
  revert: Function;
}) {
      ...
      {loading === 0 && (
        <div className="center-info submit-grid pt-5">
          <div className="button-holders">
            <button className="recede-button" onClick={previous}>
              Previous
            </button>
          </div>
          <div className="button-holders">
            <button className="proceed-button" onClick={submitPropertyData}>
              Submit for Review
            </button>
          </div>
        </div>
        ...
        <div className="loader-holder-40">
          <div className="error-box">
            ...
            <div className="text-align-center button-holders">
              <button className="proceed-button px-4" onClick={goBack}>
                Exit
              </button>
            </div>
          </div>
