...
function LocationSelectionComp(props: iLocationProps) {
  ...
  const [location, setLocation] = useState<ILocationSelection>(
    props.location || { from: undefined, to: undefined }
  );
  ...
  const airportList = airportData?.data || [];
    ...
    <div className="location-holder">
      <div className="row px-2">
        <div className="pt-3 col-sm-6 px-1">
          <div
            className={
              "location-selection" + (location.to ? " selected-label" : "")
            }
          >
            ...
            <TypeSuggestComponent
              ...
              floatOption
              initialValue={location.from?.name}
