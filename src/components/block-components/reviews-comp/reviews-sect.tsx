          ...
          {reviews.length > 0 ? (
            <>
              <div className="spread-info-front">
                <h1 className="increased-xxxl reduce-height number-bold italic mb-0">
                  {reviewStats?.average?.toFixed(1)}
                </h1>
                <div className="ps-3">
                  <h6>{reviewStats?.averageRemark}</h6>
                  <p className="mb-0">
                    {reviewStats?.count} verified review
            ...
            <Fragment key={index}>
              <div className="review">
                ...
                <div className="content">
                  <div className="spread-info-front">
                    <h6 className="increased mb-0 number-medium italic">
                      {review.rating}.0
                    </h6>{" "}
                    &nbsp; | &nbsp;
                ...
                <div className="flag">
                  {review.id === user?.id ? (
                    <FontAwesomeIcon
                      icon={"edit"}
                      className="edit orange-tx clickable increased"
